...
void display(void)
{
  ...
  if (num_cam == 1)
  {
    vglClCopy(img[0], img[1]);
  }

  vglClCopy(img[0], img[2]);
  vglClCopy(img[0], img[3]);
  vglClCopy(img[0], img[4]);

  vglClInvert(img[0], img[2]);
  vglClCopy(img[2], img[4]);

  float erosion[9] = {0,1,0,1,1,1,0,1,0};

  vglClErosion(img[2], img[3],erosion,3,3);
  vglClErosion(img[3], img[2],erosion,3,3);
  ...
  vglClThreshold(img[4], img[5],0.5);
  vglClErosion(img[5], img[6],erosion,3,3);

  vglClInvert(img[5], img[7]);
  vglClCopy(img[7], img[3]);
