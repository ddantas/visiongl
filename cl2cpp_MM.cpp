...
/** Erosion of src image by mask. Result is stored in dst image.
  ...
  */
void vglCl3dFuzzyAlgDilate(VglImage* img_input, VglImage* img_output, float* convolution_window, int window_size_x, int window_size_y, int window){
  ...
  err = clSetKernelArg( kernel, 5, sizeof( int ), &window );
